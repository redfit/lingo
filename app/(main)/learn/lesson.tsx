        ...
        {current ? (
          <div className="h-[102px] w-[102px] relative">
            <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-green-500 rounded-xl animate-bounce tracking-wide z-10">
              Start
              <div className="absolute left-1/2 -bottom-2 border-x-8 w-0 h-0 border-x-transparent border-t-8 transform -translate-x-1/2"></div>
            </div>
            <CircularProgressbarWithChildren
              value={Number.isNaN(percentage)}
              style={{
                path: { stroke: "4ade80" },
                trail: { stroke: "e5e7eb" },
              }}
